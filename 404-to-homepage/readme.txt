...
Redirect 404 missing pages to the homepage. Super lightweight!
...
This plugin is designed to be **very lightweight**. There are no options or settings (or annoying banner ads trying to sell SEO services). Simply activate the plugin and you're good to go. It will redirect 404s silently in the background without any extra overhead on your hosting.

### Features

- Works with any theme.
- Will not break wp-cron and XML-RPC requests.
- Super lightweight (only 6 lines of code).
- No extra marketing/SEO bull. It just works.
